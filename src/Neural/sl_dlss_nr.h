...
namespace sl
{
	// PORT NOTE (Skyrim): the upstream branch this came from predates Streamline
	// declaring these. Our SDK (2.13) already defines kFeatureDLSS_NR and the
	// kBufferTypeUplift* ids in sl_core_types.h, so the provisional copies are
	// dropped here -- only what the SDK still omits is declared below.
